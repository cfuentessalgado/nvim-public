...
vim.keymap.set({ 'n', 'x' }, '<leader>asp', function() require('sidekick.cli').prompt() end, { desc = 'Sidekick Select Prompt' })
...
vim.keymap.set('n', '<leader>ap', function() require('sidekick.cli').toggle { name = 'pi', focus = true } end, { desc = 'Sidekick Toggle Pi' })
